...
def blif2swcs(sys_name, project_name, board_type, out_path):
    ...
    # Creates the input vector flie. Main purpose is to put FPAA into Run Mode
...
'''
    ...
    if fix_loc:
    	...
    	print('blif2swcs - Call VTR: /home/ubuntu/rasp30/vtr_release/vpr/vpr /home/ubuntu/ashes/ashes_fg/fpaa/arch/'+arch+'_arch.xml ' + path + '/' + fname + '  -route_chan_width 17 -timing_analysis off -fix_pins ' + path + '/' + fname + '.pads -nodisp')
