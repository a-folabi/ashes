    ...
    for line in lines:
        ...
        if ' pad_in\n' in line:
            ...
            for i in range(len(pads_temp)):
                if pads_temp[i]=='1':
                    pads_final.append(in_nets[i]+' 9 0 0 #tgate[0]\n')
                elif pads_temp[i]=='2':
                    pads_final.append(in_nets[i]+' 11 0 0 #tgate[0]\n')
                elif pads_temp[i]=='3':
                    pads_final.append(in_nets[i]+' 12 0 0 #tgate[0]\n')
                elif pads_temp[i]=='4':
                    pads_final.append(in_nets[i]+' 12 0 3 #tgate[1]\n')
                elif pads_temp[i]=='5':
                    pads_final.append(in_nets[i]+' 13 0 0 #tgate[0]\n')
                elif pads_temp[i]=='6':
                    pads_final.append(in_nets[i]+' 13 0 3 #tgate[1]\n')                                  
                elif pads_temp[i]=='7':
                    pads_final.append(in_nets[i]+' 14 0 0 #tgate[0]\n')                                  
                elif pads_temp[i]=='8':
                    pads_final.append(in_nets[i]+' 14 0 3 #tgate[1]\n')                                 
                elif pads_temp[i]=='9':
                    pads_final.append(in_nets[i]+' 3 0 0 #tgate[0]\n')
                elif pads_temp[i]=='10':
                    pads_final.append(in_nets[i]+' 3 0 3 #tgate[1]\n')
                elif pads_temp[i]=='11':
                    pads_final.append(in_nets[i]+' 4 0 0 #tgate[0]\n')
                elif pads_temp[i]=='12':
        ...
        if ' pad_out\n' in line:
            ...
            for i in range(len(pads_temp)):
                if pads_temp[i]=='1':
                    pads_final.append('out:'+out_nets[i]+' 9 0 0 #tgate[0]\n')
                elif pads_temp[i]=='2':
                    pads_final.append('out:'+out_nets[i]+' 11 0 0 #tgate[0]\n')
                elif pads_temp[i]=='3':
                    pads_final.append('out:'+out_nets[i]+' 12 0 0 #tgate[0]\n')
                elif pads_temp[i]=='4':
                    pads_final.append('out:'+out_nets[i]+' 12 0 3 #tgate[1]\n')
                elif pads_temp[i]=='5':
                    pads_final.append('out:'+out_nets[i]+' 13 0 0 #tgate[0]\n')
                elif pads_temp[i]=='6':
                    pads_final.append('out:'+out_nets[i]+' 13 0 3 #tgate[1]\n')                                  
                elif pads_temp[i]=='7':
                    pads_final.append('out:'+out_nets[i]+' 14 0 0 #tgate[0]\n')                                  
                elif pads_temp[i]=='8':
                    pads_final.append('out:'+out_nets[i]+' 14 0 3 #tgate[1]\n')                                 
                elif pads_temp[i]=='9':
                    pads_final.append('out:'+out_nets[i]+' 3 0 0 #tgate[0]\n')
                elif pads_temp[i]=='10':
                    pads_final.append('out:'+out_nets[i]+' 3 0 3 #tgate[1]\n')
                elif pads_temp[i]=='11':
                    pads_final.append('out:'+out_nets[i]+' 4 0 0 #tgate[0]\n')
                elif pads_temp[i]=='12':
