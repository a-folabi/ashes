...
Atop.place([0,0])
Amatrix = IndirectVMM(Top,[20,16],island=CABIsland,decoderPlace=False,loc=[1,0])

# B matrix
Btop = BlockTop(Top,CABIsland,[1,6])
Btop.place([0,8])
Bmatrix = IndirectVMM(Top,[16,12],island=CABIsland,decoderPlace=False,loc=[1,8])
Bbot = B_bot(Top,CABIsland,[1,6])
Bbot.place([5,8])
...
BtoOut = OutSwitch(Top,CABIsland,[1,6])
BtoOut.place([7,8])

# Output Matrix
Outmatrix = IndirectVMM(Top,[8,12],island=CABIsland,decoderPlace=False,loc=[8,8])
Oswitch = ST_BMatrix(Top,CABIsland,[2,1])
Oswitch.place([8,14])

# CAB Elements
TA2Cell_NoFG__0 = TSMC350nm_TA2Cell_NoFG(Top,CABIsland)
TA2Cell_NoFG__0.place([2,15])
TA2Cell_NoFG__0.markCABDevice()

TA2Cell_NoFG__1 = TSMC350nm_TA2Cell_NoFG(Top,CABIsland)
TA2Cell_NoFG__1.place([3,15])
TA2Cell_NoFG__1.markCABDevice()

TGate_2nMirror__0 = TSMC350nm_TGate_2nMirror(Top,CABIsland)
TGate_2nMirror__0.place([4,15])
TGate_2nMirror__0.markCABDevice()

TGate_2nMirror__1 = TSMC350nm_TGate_2nMirror(Top,CABIsland)
TGate_2nMirror__1.place([5,15])
TGate_2nMirror__1.markCABDevice()
...
TA2Cell_NoFG__0.VD_P += Bswitch0.P[0:2]
TA2Cell_NoFG__0.VIN1_PLUS += Bswitch0.A[0]
TA2Cell_NoFG__0.VIN1_MINUS += Bswitch0.A[1]
TA2Cell_NoFG__0.VIN2_PLUS += Bswitch0.A[2]
TA2Cell_NoFG__0.VIN2_MINUS += Bswitch0.A[3]
TA2Cell_NoFG__0.OUTPUT += CAB_GateSwitch.Input[16:18]
TA2Cell_NoFG__0.VTUN += CABElements_GateSwitch.VTUN
TA2Cell_NoFG__0.Vg += CABElements_GateSwitch.Vg[0]
TA2Cell_NoFG__0.Vsel += CABElements_GateSwitch.CTRL_B[0]
TA2Cell_NoFG__0.VINJ += CABElements_GateSwitch.VINJ
TA2Cell_NoFG__0.GND += CABElements_GateSwitch.GND[0]
TA2Cell_NoFG__0.VPWR += CABElements_GateSwitch.VDD[1]

TA2Cell_NoFG__1.VD_P += Bswitch1.P[0:2]
TA2Cell_NoFG__1.VIN1_PLUS += Bswitch1.A[0]
TA2Cell_NoFG__1.VIN1_MINUS += Bswitch1.A[1]
TA2Cell_NoFG__1.VIN2_PLUS += Bswitch1.A[2]
TA2Cell_NoFG__1.VIN2_MINUS += Bswitch1.A[3]
TA2Cell_NoFG__1.OUTPUT += CAB_GateSwitch.Input[18:20]
TA2Cell_NoFG__1.VTUN += TA2Cell_NoFG__0.VTUN_b
TA2Cell_NoFG__1.Vg += TA2Cell_NoFG__0.Vg_b
TA2Cell_NoFG__1.Vsel += TA2Cell_NoFG__0.Vsel_b
TA2Cell_NoFG__1.VINJ += TA2Cell_NoFG__0.VINJ_b
TA2Cell_NoFG__1.GND += TA2Cell_NoFG__0.GND_b
TA2Cell_NoFG__1.VPWR += TA2Cell_NoFG__0.VPWR_b

TGate_2nMirror__0.IN_CM += Bswitch2.A[0:2]
TGate_2nMirror__0.SelN += Bswitch2.A[2]
TGate_2nMirror__0.IN_TG += Bswitch2.A[3]
TGate_2nMirror__0.OUT_CM += CAB_GateSwitch.Input[20:22]
TGate_2nMirror__0.OUT_TG += CAB_GateSwitch.Input[22]
TGate_2nMirror__0.VPWR += TA2Cell_NoFG__1.VPWR_b
TGate_2nMirror__0.GND += TA2Cell_NoFG__1.GND_b

TGate_2nMirror__1.IN_CM += Bswitch3.A[0:2]
TGate_2nMirror__1.SelN += Bswitch3.A[2]
TGate_2nMirror__1.IN_TG += Bswitch3.A[3]
TGate_2nMirror__1.OUT_CM += CAB_GateSwitch.Input[23:25]
TGate_2nMirror__1.OUT_TG += CAB_GateSwitch.Input[25]
TGate_2nMirror__1.VPWR += TGate_2nMirror__0.VPWR_b
TGate_2nMirror__1.GND += TGate_2nMirror__0.GND_b
...
NandPfets.VPWR += TGate_2nMirror__1.VPWR_b
NandPfets.GND += TGate_2nMirror__1.GND_b
...
VolSwitch.com += CAB_GateSwitch.Input[15]
