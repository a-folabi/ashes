...
Bswitch3 = ST_BMatrix(Top,CABIsland)
Bswitch3.place([3,18])
Bswitch3.markAbut()

Bswitch4 = ST_BMatrix_NoSwitch(Top,CABIsland)
Bswitch4.place([4,18])
Bswitch4.markAbut()
...
TA2Cell_Weak__0.VD_P += Bswitch0.P[1:3]
TA2Cell_Weak__0.VIN1_PLUS += Bswitch0.A[1]
TA2Cell_Weak__0.VIN1_MINUS += Bswitch0.A[2]
TA2Cell_Weak__0.VIN2_PLUS += Bswitch0.A[3]
TA2Cell_Weak__0.VIN2_MINUS += Bswitch1.A[0]
TA2Cell_Weak__0.OUTPUT += CAB_GateSwitch.Input[17:19]
TA2Cell_Weak__0.Vsel += CABElements_GateSwitch.CTRL_B
TA2Cell_Weak__0.RUN += CABElements_GateSwitch.run_r
TA2Cell_Weak__0.Vg += CABElements_GateSwitch.Vg
...
TA2Cell_Weak__1.VIN1_PLUS += Bswitch1.A[1]
TA2Cell_Weak__1.VIN1_MINUS += Bswitch1.A[2]
TA2Cell_Weak__1.VIN2_PLUS += Bswitch1.A[3]
TA2Cell_Weak__1.VIN2_MINUS += Bswitch2.A[0]
TA2Cell_Weak__1.OUTPUT += CAB_GateSwitch.Input[19:21]
TA2Cell_Weak__1.Vsel += TA2Cell_Weak__0.Vsel_b
TA2Cell_Weak__1.RUN += TA2Cell_Weak__0.RUN_b
TA2Cell_Weak__1.Vg += TA2Cell_Weak__0.Vg_b
...
TA2Cell_Strong.VIN1_PLUS += Bswitch2.A[1]
TA2Cell_Strong.VIN1_MINUS += Bswitch2.A[2]
TA2Cell_Strong.VIN2_PLUS += Bswitch2.A[3]
TA2Cell_Strong.VIN2_MINUS += Bswitch3.A[0]
TA2Cell_Strong.OUTPUT += CAB_GateSwitch.Input[21:23]
TA2Cell_Strong.Vsel += TA2Cell_Weak__1.Vsel_b
TA2Cell_Strong.RUN += TA2Cell_Weak__1.RUN_b
TA2Cell_Strong.Vg += TA2Cell_Weak__1.Vg_b
...
WTA_IndirectProg.VD_P += Bswitch4.P[0:4]
WTA_IndirectProg.Iin += Bswitch4.A[0:4]
WTA_IndirectProg.Vout += CAB_GateSwitch.Input[25:29]
WTA_IndirectProg.Vmid += CAB_GateSwitch.Input[29]
WTA_IndirectProg.Vbias += CAB_GateSwitch.Input[30]
...
FakeCell6 = FakeCell(Top,CABIsland)
FakeCell6.place([50,56])
Block_GateDecode.RUN_OUT[6] += FakeCell6.FakePort
FakeCell7 = FakeCell(Top,CABIsland)
FakeCell7.place([50,57])
Block_GateDecode.RUN_OUT[7] += FakeCell7.FakePort
...
FakeCell22 = FakeCell(Top,CABIsland)
FakeCell22.place([50,72])
Block_GateDecode.RUN_OUT[22] += FakeCell22.FakePort
FakeCell23 = FakeCell(Top,CABIsland)
FakeCell23.place([50,73])
Block_GateDecode.RUN_OUT[23] += FakeCell23.FakePort
FakeCell24 = FakeCell(Top,CABIsland)
FakeCell24.place([50,74])
Block_GateDecode.RUN_OUT[24] += FakeCell24.FakePort
FakeCell25 = FakeCell(Top,CABIsland)
FakeCell25.place([50,75])
Block_GateDecode.RUN_OUT[25] += FakeCell25.FakePort
...
FakeCell34 = FakeCell(Top,CABIsland)
FakeCell34.place([50,84])
Block_GateDecode.RUN_OUT[34] += FakeCell34.FakePort
FakeCell35 = FakeCell(Top,CABIsland)
FakeCell35.place([50,85])
Block_GateDecode.RUN_OUT[35] += FakeCell35.FakePort
FakeCell36 = FakeCell(Top,CABIsland)
FakeCell36.place([50,86])
Block_GateDecode.RUN_OUT[36] += FakeCell36.FakePort
FakeCell37 = FakeCell(Top,CABIsland)
FakeCell37.place([50,87])
Block_GateDecode.RUN_OUT[37] += FakeCell37.FakePort
FakeCell38 = FakeCell(Top,CABIsland)
FakeCell38.place([50,88])
Block_GateDecode.RUN_OUT[38] += FakeCell38.FakePort
FakeCell39 = FakeCell(Top,CABIsland)
FakeCell39.place([50,89])
Block_GateDecode.RUN_OUT[39] += FakeCell39.FakePort
...
CABElements_GateSwitch.VPWR[1] += CAB_GateSwitch.AVDD_r
CABElements_GateSwitch.VPWR[0] += CAB_GateSwitch.AVDD_r
CABElements_GateSwitch.PROG += CAB_GateSwitch.prog_r
Block_GateSwitch.prog_r += Block_Switch.Prog
CABElements_GateSwitch.RUN += CAB_GateSwitch.run_r
CAB_GateSwitch.run_r += Block_GateSwitch.run_r
...
Bswitch0.Prog += CAB_GateSwitch.prog_r
Oswitch.GND += Bswitch7.GND_b
Oswitch.VDD += Bswitch7.VDD_b
Oswitch.Prog += Bswitch7.Prog_b
...
Block_GateSwitch.RUN_IN[14] += CAB_GateSwitch.Vgrun
Block_GateSwitch.RUN_IN[15] += CAB_GateSwitch.Vgrun
Block_GateSwitch.RUN_IN[28] += CAB_GateSwitch.Vgrun
Block_GateSwitch.RUN_IN[29] += CAB_GateSwitch.Vgrun
...
Block_GateSwitch.RUN_IN[44] += CAB_GateSwitch.Vgrun
Block_GateSwitch.RUN_IN[45] += CAB_GateSwitch.Vgrun
Block_GateSwitch.RUN_IN[46] += CAB_GateSwitch.Vgrun
Block_GateSwitch.RUN_IN[47] += CAB_GateSwitch.Vgrun
Block_GateSwitch.RUN_IN[48] += CAB_GateSwitch.Vgrun
Block_GateSwitch.RUN_IN[49] += CAB_GateSwitch.Vgrun
Block_GateSwitch.RUN_IN[50] += CAB_GateSwitch.Vgrun
Block_GateSwitch.RUN_IN[51] += CAB_GateSwitch.Vgrun

outerFrame = frame(Top)
outerFrame.createPort("N","gateEN",connection = Block_GateDecode.ENABLE)
outerFrame.createPort("N","gatebit5",connection = Block_GateDecode.IN[5])
outerFrame.createPort("N","gatebit4",connection = Block_GateDecode.IN[4])
outerFrame.createPort("N","gatebit3",connection = Block_GateDecode.IN[3])
outerFrame.createPort("N","gatebit2",connection = Block_GateDecode.IN[2])
outerFrame.createPort("N","gatebit1",connection = Block_GateDecode.IN[1])
outerFrame.createPort("N","gatebit0",connection = Block_GateDecode.IN[0])
...
outerFrame.createPort("N","prog",connection = Block_Switch.Prog)
outerFrame.createPort("N","run",connection = Block_GateSwitch.run_r)
Block_GateSwitch.RUN += Block_DrainCutoff.RUN
Block_GateSwitch.RUN += CAB_GateSwitch.run
CAB_GateSwitch.run += CAB_DrainSwitch.RUN
outerFrame.createPort("N","vgsel",connection = Block_GateSwitch.vgsel_r)
CABElements_GateSwitch.vgsel_r += Block_GateSwitch.vgsel_r
outerFrame.createPort("S","gateEN",connection = Block_GateDecode.ENABLE)
outerFrame.createPort("S","gatebit5",connection = Block_GateDecode.IN[5])
outerFrame.createPort("S","gatebit4",connection = Block_GateDecode.IN[4])
outerFrame.createPort("S","gatebit3",connection = Block_GateDecode.IN[3])
outerFrame.createPort("S","gatebit2",connection = Block_GateDecode.IN[2])
outerFrame.createPort("S","gatebit1",connection = Block_GateDecode.IN[1])
outerFrame.createPort("S","gatebit0",connection = Block_GateDecode.IN[0])
...
outerFrame.createPort("S","prog",connection = Oswitch.Prog_b)
outerFrame.createPort("S","run",connection = CAB_GateSwitch.run_r)
outerFrame.createPort("S","vgsel",connection = CABElements_GateSwitch.vgsel_r)
...
compile_asic(Top,process="TSMC350nm",fileName="cab1",p_and_r = True,design_limits = design_limits, location_islands = location_islands)
