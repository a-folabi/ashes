...
Amatrix_col = int(data["Amatrix_cols"]/2)
...
#E ports
f.write('outerFrame.createPort("E","cns0",connection = Block_GateDecode.VGRUN['+str(CEW_col+CNS_col-2)+'])\n')
f.write('outerFrame.createPort("E","cns1",connection = Block_GateDecode.VGRUN['+str(CEW_col+CNS_col-1)+'])\n')
f.write('outerFrame.createPort("E","cns2",connection = Block_GateDecode.VGRUN['+str(CEW_col+CNS_col)+'])\n')
f.write('outerFrame.createPort("E","cns3",connection = Block_GateDecode.VGRUN['+str(CEW_col+CNS_col+1)+'])\n')
...
f.write("\n# Compilation\n")
f.write("design_limits = [1e6, 6.6e5]\n")
f.write("location_islands = ((20600, 400000), (20600, 20000), (160000,20000))\n")
