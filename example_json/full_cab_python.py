...
Block_GateDecode.VINJ_b[0] += CABElements_GateSwitch.VINJ_T
Block_GateDecode.GND_b[0] += CABElements_GateSwitch.GND_T
Block_GateDecode.VINJ_b[1] += CABElements_GateSwitch.VINJ_T
Block_GateDecode.GND_b[1] += CABElements_GateSwitch.GND_T
Block_GateDecode.VINJ_b[2] += CABElements_GateSwitch.VINJ_T
Block_GateDecode.GND_b[2] += CABElements_GateSwitch.GND_T
Block_GateDecode.VINJ_b[3] += CABElements_GateSwitch.VINJ_T
Block_GateDecode.GND_b[3] += CABElements_GateSwitch.GND_T
Block_GateDecode.VINJ_b[4] += CABElements_GateSwitch.VINJ_T
Block_GateDecode.GND_b[4] += CABElements_GateSwitch.GND_T
Block_GateDecode.VINJ_b[5] += CABElements_GateSwitch.VINJ_T
Block_GateDecode.GND_b[5] += CABElements_GateSwitch.GND_T
Block_GateDecode.VINJ_b[6] += CABElements_GateSwitch.VINJ_T
Block_GateDecode.GND_b[6] += CABElements_GateSwitch.GND_T
Block_GateDecode.VINJ_b[7] += CABElements_GateSwitch.VINJ_T
Block_GateDecode.GND_b[7] += CABElements_GateSwitch.GND_T
...
Bswitch7.Prog_b += Block_Switch.Prog_b
Oswitch.GND_b += CABElements_GateSwitch.GND_T
Oswitch.VDD_b += CABElements_GateSwitch.VPWR[1]
Oswitch.Prog_b += Block_Switch.Prog_b
Block_GateSwitch.RUN_IN[0] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[1] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[2] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[3] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[4] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[5] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[6] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[7] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[8] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[9] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[10] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[11] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[12] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[13] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[14] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[15] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[28] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[29] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[32] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[33] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[34] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[35] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[36] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[37] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[38] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[39] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[40] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[41] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[42] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[43] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[44] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[45] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[46] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[47] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[48] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[49] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[50] += BtoOut.Vgrun_r
Block_GateSwitch.RUN_IN[51] += BtoOut.Vgrun_r
